...
public class LoginSteps extends AbstractSteps {
	...
	@Then("^I will see the message \"([^\"]*)\"$") //invalid email
	public void i_will_see_the_message(String arg1) throws Throwable {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebDriverWait wait = new WebDriverWait(driver, 60);
		wait.until(
				ExpectedConditions.textToBePresentInElement(
						(By.cssSelector(
								"#lg-account-form > div:nth-child(1) > div > div > account-feedback > span")),
						arg1));
	}
	...
	public void i_will_see_error_message(String arg1) throws Throwable {
		...
		wait.until(
				ExpectedConditions.textToBePresentInElement(
						(By.cssSelector(
								"#lg-account-form > div.lg-reset-pass-form.col-xs-12 > account-feedback > span")),
						arg1));
	}
	...
	public void i_logout() throws Throwable {
		...
		WebElement element = driver
				.findElement(By.cssSelector("#meny-gbg-nav > ul.nav.navbar-nav.navbar-right > li > a"));
		element.click();
		WebElement logout = driver.findElement(
				By.cssSelector("#meny-gbg-nav > ul.nav.navbar-nav.navbar-right > li > ul > li:nth-child(2) > a"));
		logout.click();
	}
